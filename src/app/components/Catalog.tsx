                        ...
                        <>
                            <div className="px-[4%] py-[4%] w-full flex flex-col items-start text-start">
                                ...
                                <div className='flex w-full justify-between'>
                                    ...
                                    <div className='bg-[#f8e4dc] rounded-md w-[300px] justify-center items-center flex flex-col'>
                                        <div className='flex w-[270px] h-8 bg-black items-center justify-center mt-5'>
